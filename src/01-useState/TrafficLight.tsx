...
//! En dado caso que la variable colors se coloque mas colores, tendriamos que colocar los mismos colores en el type TrafficLightColor o
//! hacer lo siguiente
//? se hace de esta manera con el keyof porque quiero que coja solo las llaves del objeto colors 
